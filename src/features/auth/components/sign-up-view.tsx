...
//       const res = await axios.post(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/v1/admin`, {
//         name: name,
//         firebaseId: user.uid,
//         email: user.email
//       });
...
//       await axios.post(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/v1/admin`, {
...
//                   disabled={loading}
//                   className={`${isDark ? 'border-gray-700 bg-black text-white placeholder-gray-500' : 'border-gray-300 bg-white text-gray-900'}`} // <-- CHANGE HERE
//                 />
//                 {formErrors?.name && (
